...
const keyFeatures = [
  "Modern Laboratory — State-of-the-art analytical instruments for hands-on training",
  "Expert Faculty — Learn from experienced researchers and industry professionals",
  "Industry Linkage — Direct collaboration with chemical and pharmaceutical industries",
  "International Standards — Training aligned with global analytical chemistry practices",
];

const trainingTopics = [
  "UV-Vis Spectroscopy", "HPLC Operations & Methods", "Gas Chromatography (GC)",
  "Titration Techniques", "pH & Conductivity Measurements", "Sample Preparation Methods",
  "Quality Control & Assurance", "Research Methodology", "Method Development & Validation",
  "Scientific Writing",
];
...
const equipment = [
  ...
  "pH Meters & Conductivity Meters", "Analytical Balances",
  "Centrifuges & Rotary Evaporators", "Fume Hoods & Safety Equipment",
];

const researchAreas = [
  "Analytical Method Development", "Environmental Monitoring", "Material Characterization",
  "Green Chemistry Applications", "Polymer Analysis", "Food & Pharmaceutical Analysis",
];
...
const careerPathways = [
  {
    ...
    opportunities: ["PhD in Analytical Chemistry", "Masters in Material Science", "Research Fellowship Programs", "Exchange Student Programs"],
  },
  {
      ...
      <Section className="section bg-white" >
        <div className="container-custom" id="programs">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            Comprehensive hands-on training designed to build practical skills for higher education and professional careers.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-5">
              ...
              <div className="p-5 border-2 border-amber-200 bg-amber-50/50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">Intensive practical training with all core instruments and techniques.</p>
              </div>
            ...
            <div>
              ...
              <div className="mt-8 border-l-2 border-emerald-400 pl-5">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Additional 2 months dedicated to conducting original research under expert supervision. Strengthens your profile for PhD applications and international scholarships.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <p className="text-gray-600 mb-6">Train on industry-standard analytical instruments used in research labs and industries worldwide.</p>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                <div>
                  <p className="text-xs text-gray-400 mb-0.5">Chemistry Department</p>
                ...
                {modalStep === "info" && (
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {[
                          { value: "short" as const, label: "Short Term — 4 months", sub: "Practical training" },
                          { value: "long" as const, label: "Long Term — 6 months", sub: "Training + Research Project" },
                        ].map((p) => (
