            ...
            <div className="space-y-5">
              ...
              <div className="p-5 border-2 border-amber-200 bg-amber-50/50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Intensive practical training in polymer processing, molding,
                  and quality control.
                </p>
              </div>
            ...
            <div>
              ...
              <div className="mt-8 border-l-2 border-emerald-400 pl-5">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Additional 2 months dedicated to polymer research under expert
                  supervision. Topics include biodegradable polymers, recycling
      ...
      <Section className="section bg-white">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            ...
            careers, and plastic industry positions.
          </p>
      ...
      <Section className="section bg-gray-50">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl">
            KRTC's Polymer department promotes environmental awareness through
            plastic recycling education, supports local SMEs with technical
            guidance, and conducts community outreach programs.
          </p>
                        ...
                        {[
                          {
                            ...
                            sub: "4 months \u2022 Processing & Quality Control",
                          },
                          {
                            value: "long" as const,
