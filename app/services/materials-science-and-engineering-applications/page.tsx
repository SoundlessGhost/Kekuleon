...
const keyFeatures = [
  "Advanced Testing — State-of-the-art equipment for mechanical and structural analysis",
  "Failure Analysis — Learn to identify and analyze material failures systematically",
  "Metallography — Microstructure examination and preparation techniques",
  "ASTM Standards — Training aligned with international testing standards",
];

const trainingTopics = [
  "Material Testing Methods", "Tensile & Hardness Testing", "Impact & Fatigue Testing",
  "Metallography & Microscopy", "Sample Preparation Techniques", "Non-Destructive Testing (NDT)",
  "Failure Analysis", "Microstructure Analysis", "Quality Control Methods",
  "ASTM Standards Compliance",
];

const equipment = [
  "Universal Testing Machine (UTM)", "Hardness Testers (Rockwell, Vickers, Brinell)",
  "Impact Testing Machine", "Optical Microscope",
  "XRF Analyzer", "Ultrasonic Thickness Gauge",
  "Surface Roughness Tester", "Digital Image Analysis System",
];

const researchAreas = [
  "Metal Alloy Development", "Composite Materials", "Corrosion Studies",
  "Surface Engineering", "Heat Treatment Optimization", "Welding Metallurgy",
];
...
const careerPathways = [
  {
    ...
    opportunities: ["PhD in Materials Science", "Masters in Metallurgical Engineering", "Research Fellowship Programs", "Materials Engineering Certification"],
  },
  {
    title: "Academic Career Path",
    description: "Build a career in teaching and research institutions",
    opportunities: ["University Lecturer", "Research Scientist", "Materials Researcher", "Lab Director"],
  },
  {
    title: "Industry Career Path",
    description: "Join leading manufacturing and engineering companies",
    opportunities: ["Materials Engineer", "Quality Inspector", "NDT Technician", "Metallurgist"],
  },
];

const communityServices = [
  { title: "Material Testing for Local Industries", description: "Affordable testing services for small and medium enterprises in the region." },
  { title: "Engineering Workshops", description: "Free workshops on material selection and quality control for local manufacturers." },
  { title: "Student Mentorship Program", description: "Guidance and career counseling for engineering students across Bangladesh." },
  { title: "Industrial Safety Training", description: "Community programs on workplace safety and material handling best practices." },
];
    ...
    <>
      ...
      <Section className="section bg-white" >
        <div className="container-custom" id="programs">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            Comprehensive hands-on training designed to build expertise in materials testing and analysis.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-5">
              ...
              <div className="p-5 border-2 border-amber-200 bg-amber-50/50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">Intensive practical training in material testing, NDT, and quality control.</p>
              </div>
            ...
            <div>
              ...
              <div className="mt-8 border-l-2 border-emerald-400 pl-5">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Additional 2 months dedicated to materials research under expert supervision. Topics include alloy development, failure analysis, or composite materials.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <p className="text-gray-600 mb-6">Train on industry-standard materials testing equipment used in manufacturing and quality control laboratories.</p>
      ...
      <Section className="section bg-white">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">Our training opens doors to international higher education, academic careers, and engineering industry positions.</p>
      ...
      <Section className="section bg-gray-50">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl">
            KRTC's Materials Science department supports local industries and communities through affordable testing services, technical workshops, and educational outreach programs.
          </p>
      ...
      <Section className="py-16 bg-white">
        <div className="container-custom text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Build Your Engineering Career</h2>
          <p className="text-gray-600 mb-8">
            Join KRTC's Materials Science department and develop expertise in material testing and analysis. Scholarship opportunities available.
          </p>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                <div>
                  <p className="text-xs text-gray-400 mb-0.5">Materials Science Department</p>
              ...
              <div className="px-6 py-5">
                {modalStep === "info" && (
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {[
                          { value: "short" as const, label: "Short Term — 4 months", sub: "4 months \u2022 Testing & Analysis" },
                ...
                {modalStep === "success" && (
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">Your interest in Materials Science has been registered. We'll contact you soon.</p>
