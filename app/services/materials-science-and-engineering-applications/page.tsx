            ...
            <div className="space-y-5">
              ...
              <div className="p-5 border-2 border-amber-200 bg-amber-50/50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Intensive practical training in material testing, NDT, and
                  quality control.
                </p>
              </div>
            ...
            <div>
              ...
              <div className="mt-8 border-l-2 border-emerald-400 pl-5">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Additional 2 months dedicated to materials research under
                  expert supervision. Topics include alloy development, failure
                  analysis, or composite materials.
                </p>
              </div>
            </div>
          </div>
      ...
      <Section className="section bg-white">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            ...
            careers, and engineering industry positions.
          </p>
      ...
      <Section className="section bg-gray-50">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl">
            KRTC's Materials Science department supports local industries and
            communities through affordable testing services, technical
      ...
      <Section className="py-16 bg-white">
        <div className="container-custom text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mb-8">
            ...
            material testing and analysis. Scholarship opportunities available.
          </p>
