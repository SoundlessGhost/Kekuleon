...
const keyFeatures = [
  "GMP Standards — Training aligned with Good Manufacturing Practice guidelines.",
  "Regulatory Focus — Understanding of DGDA and international regulatory requirements.",
  "Advanced Labs — Modern pharmaceutical testing and formulation facilities.",
  "Global Standards — Curriculum aligned with WHO and FDA guidelines.",
];

const trainingTopics = [
  "Drug Formulation & Development", "Quality Control Analysis", "Regulatory Affairs & DGDA",
  "Stability Studies (ICH Guidelines)", "GMP Compliance", "Dissolution Testing",
  "Pharmaceutical Calculations", "Documentation & SOP", "Analytical Method Validation",
  "Pharmacovigilance Basics",
];

const equipment = [
  "Dissolution Testing Apparatus", "HPLC with UV/PDA Detector",
  "Tablet Hardness Tester", "Friability Tester",
  "Disintegration Apparatus", "Karl Fischer Titrator",
  "Stability Chambers", "Particle Size Analyzer",
];

const researchAreas = [
  "Novel Drug Delivery Systems", "Bioequivalence Studies", "Herbal Drug Standardization",
  "Nanotechnology in Pharma", "Generic Drug Development", "Pharmacokinetics Research",
];
...
const careerPathways = [
  {
    ...
    opportunities: ["PhD in Pharmaceutical Sciences", "Masters in Drug Development", "Research Fellowship Programs", "Regulatory Affairs Certification"],
  },
  {
    title: "Academic Career Path",
    description: "Build a career in teaching and research institutions",
    opportunities: ["University Lecturer", "Research Scientist", "Pharmaceutical Researcher", "Academic Consultant"],
  },
  {
    title: "Industry Career Path",
    description: "Join leading pharmaceutical companies",
    opportunities: ["Quality Control Manager", "Regulatory Affairs Officer", "Formulation Scientist", "Production Manager"],
  },
];

const communityServices = [
  { title: "Medicine Awareness Programs", description: "Educational workshops on proper medication use and avoiding counterfeit drugs." },
  { title: "Health Screening Camps", description: "Free health checkups and pharmaceutical consultations for underserved communities." },
  { title: "Pharmacy Student Mentorship", description: "Guidance and career counseling for pharmacy students across Bangladesh." },
  { title: "Drug Safety Education", description: "Community programs on drug interactions, side effects, and safe storage." },
];
    ...
    <>
      ...
      <Section className="section bg-white" >
        <div className="container-custom" id="programs">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            Comprehensive hands-on training designed to build practical skills in pharmaceutical sciences.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-5">
              ...
              <div className="p-5 border-2 border-amber-200 bg-amber-50/50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">Intensive practical training in QC, formulation, and GMP compliance.</p>
              </div>
            ...
            <div>
              ...
              <div className="mt-8 border-l-2 border-emerald-400 pl-5">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Additional 2 months dedicated to pharmaceutical research under expert supervision. Topics include drug formulation, stability studies, or regulatory research.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <p className="text-gray-600 mb-6">Train on industry-standard pharmaceutical testing equipment used in manufacturing and quality control laboratories.</p>
      ...
      <Section className="section bg-white">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">Our training opens doors to international higher education, academic careers, and pharmaceutical industry positions.</p>
      ...
      <Section className="section bg-gray-50">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl">
            KRTC's Pharmaceutical department is committed to improving public health through awareness programs, free consultations, and educational outreach about safe medication practices.
          </p>
      ...
      <Section className="py-16 bg-white">
        <div className="container-custom text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Start Your Pharmaceutical Career</h2>
          <p className="text-gray-600 mb-8">
            Join KRTC's Pharmaceutical department and gain industry-ready skills. Scholarship opportunities available.
          </p>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                <div>
                  <p className="text-xs text-gray-400 mb-0.5">Pharmaceutical Sciences</p>
              ...
              <div className="px-6 py-5">
                {modalStep === "info" && (
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {[
                          { value: "short" as const, label: "Short Term — 4 months", sub: "4 months \u2022 QC & GMP Training" },
                ...
                {modalStep === "success" && (
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">Your interest in Pharmaceutical Sciences has been registered. We'll contact you soon about the October 2026 intake.</p>
