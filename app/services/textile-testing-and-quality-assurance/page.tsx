...
export default function TextilePage() {
  ...
  const keyFeatures = [
    {
      ...
      description: "Physical and chemical testing of textile materials.",
    },
    {
      icon: Palette,
      title: "Color Analysis",
      description: "Color matching, fastness testing, and spectrophotometry.",
    },
    {
      icon: Ruler,
      title: "Quality Standards",
      description: "ISO, ASTM, and buyer-specific compliance training.",
    },
    {
      icon: Globe,
      title: "Export Compliance",
      description: "International standards for RMG export quality.",
    },
  ];
  ...
  const communityServices = [
    {
      title: "SME Quality Support",
      description:
        "Affordable testing services for small garment manufacturers.",
    },
    {
      title: "Worker Training Programs",
      description: "Quality awareness training for RMG factory workers.",
    },
    {
      title: "Student Internships",
      description:
        "Industry exposure programs for textile engineering students.",
    },
    {
      title: "Compliance Workshops",
      description:
        "Free workshops on international quality and safety standards.",
    },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-indigo-500/5 rounded-full blur-[120px]" />
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Our department focuses on innovative textile technologies and
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive hands-on training in fabric testing, quality
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            >
              <div className="bg-white rounded-2xl p-6 border border-gray-100 sticky top-24">
                ...
                {/* Short Term */}
                <div className="p-4 bg-indigo-50 rounded-xl border-2 border-indigo-200 mb-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-indigo-700 font-semibold">4 Months</p>
            ...
            >
              <div className="bg-white rounded-2xl p-8 border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">
                  Comprehensive training covering textile testing, quality
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm mb-3">
                        Additional 2 months dedicated to textile research under
                        expert supervision. Topics include sustainable textiles,
                        performance fabrics, or quality optimization.
                      </p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              academic careers, and RMG industry positions.
            </p>
          </motion.div>
            ...
            {Object.entries(careerPathways).map(([key, pathway], index) => {
              ...
              const colorClasses = [
                ...
                },
                {
                  ...
                  item: "bg-indigo-50 text-indigo-700",
                },
              ][index];
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-primary to-red-700 rounded-2xl p-8 text-white h-full">
                ...
                <p className="text-red-100 leading-relaxed mb-6">
                  KRTC's Textile department supports Bangladesh's RMG sector
                  through affordable testing services for SMEs, worker training
                  programs, and compliance workshops.
                </p>

                <div className="flex items-center gap-3">
                  <HandHeart className="w-8 h-8 text-red-200" />
                  <span className="text-red-100 font-medium">
                    Supporting RMG communities since 2025
                  </span>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Our Textile Testing department offers industry-aligned training
                with RMG sector focus, preparing you for success in Bangladesh's
                largest export industry or higher education abroad.
              </p>
            </motion.div>
      ...
      >
        ...
        <div className="absolute bottom-10 right-1/4 w-96 h-96 bg-indigo-500/5 rounded-full blur-[120px]" />
            ...
            >
              ...
              <div className="bg-gradient-to-r from-primary to-red-700 p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-red-200 text-sm mb-1">Textile Testing</p>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              4 months • Testing & Quality Control
                            </p>
                          </div>
                        </label>
                        <label
