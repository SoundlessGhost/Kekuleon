...
const department = {
  ...
  heroDescription:
    "Master textile testing, quality control, and compliance standards with hands-on training for Bangladesh's leading export industry.",
  overview:
    "The Textile Testing department at KRTC provides comprehensive training in fabric testing, quality assurance, and compliance standards. Our programs prepare students for careers in Bangladesh's RMG sector, with pathways to higher education abroad in textile engineering and materials science.",
};

const keyFeatures = [
  "Fabric Testing — Physical and chemical testing of textile materials",
  "Color Analysis — Color matching, fastness testing, and spectrophotometry",
  "Quality Standards — ISO, ASTM, and buyer-specific compliance training",
  "Export Compliance — International standards for RMG export quality",
];

const trainingTopics = [
  "Fabric Composition Analysis", "Tensile Strength Testing", "Color Fastness Testing",
  "Shrinkage & Dimensional Stability", "Pilling Resistance", "GSM & Weight Analysis",
  "Seam Strength Testing", "Water Resistance Testing", "Flammability Testing",
  "Quality Documentation",
];

const equipment = [
  "Tensile Strength Tester", "Color Matching Cabinet",
  "Spectrophotometer", "Martindale Abrasion Tester",
  "Crockmeter", "Washing Fastness Machine",
  "GSM Cutter & Balance", "Fabric Thickness Gauge",
];

const researchAreas = [
  "Sustainable Textiles", "Performance Fabrics", "Quality Optimization",
  "Eco-Friendly Dyes", "Technical Textiles", "Smart Fabrics",
];
...
const careerPathways = [
  {
    ...
    opportunities: ["PhD in Textile Engineering", "Masters in Textile Science", "Research Fellowship Programs", "Quality Management Certification"],
  },
  {
    title: "Academic Career Path",
    description: "Build a career in teaching and research institutions",
    opportunities: ["University Lecturer", "Research Scientist", "Textile Researcher", "Lab Director"],
  },
  {
    title: "Industry Career Path",
    description: "Join leading RMG and textile companies",
    opportunities: ["Quality Control Manager", "Lab In-charge", "Compliance Officer", "Technical Manager"],
  },
];

const communityServices = [
  { title: "SME Quality Support", description: "Affordable testing services for small garment manufacturers." },
  { title: "Worker Training Programs", description: "Quality awareness training for RMG factory workers." },
  { title: "Student Internships", description: "Industry exposure programs for textile engineering students." },
  { title: "Compliance Workshops", description: "Free workshops on international quality and safety standards." },
];

const whyChoose = [
  "Training aligned with RMG industry requirements",
  "Industry-experienced quality professionals as instructors",
  "Direct pathway to international higher education",
  "Strong connections with garment industry",
  "Buyer-specific compliance training",
    ...
    <>
      ...
      <Section className="section bg-white" >
        <div className="container-custom" id="programs">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            Comprehensive hands-on training in fabric testing, quality control, and compliance standards.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-5">
              ...
              <div className="p-5 border-2 border-amber-200 bg-amber-50/50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">Intensive practical training in textile testing, quality control, and compliance.</p>
              </div>
            ...
            <div>
              ...
              <div className="mt-8 border-l-2 border-emerald-400 pl-5">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Additional 2 months dedicated to textile research under expert supervision. Topics include sustainable textiles, performance fabrics, or quality optimization.
                </p>
              </div>
            </div>
          </div>
      ...
      <Section className="section bg-gray-50">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              <h2 className="heading-lg mb-5">Equipment & Instruments</h2>
              <p className="text-gray-600 mb-6">Train on industry-standard textile testing equipment used in quality labs across Bangladesh's RMG sector.</p>
      ...
      <Section className="section bg-white">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">Our training opens doors to international higher education, academic careers, and RMG industry positions.</p>
      ...
      <Section className="section bg-gray-50">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl">
            KRTC's Textile department supports Bangladesh's RMG sector through affordable testing services for SMEs, worker training programs, and compliance workshops.
          </p>
      ...
      <Section className="py-16 bg-white">
        <div className="container-custom text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Start Your Textile Quality Career</h2>
          <p className="text-gray-600 mb-8">
            Join KRTC's Textile Testing department and develop expertise in quality assurance for Bangladesh's RMG sector. Scholarship opportunities available.
          </p>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                <div>
                  <p className="text-xs text-gray-400 mb-0.5">Textile Testing Department</p>
              ...
              <div className="px-6 py-5">
                {modalStep === "info" && (
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {[
                          { value: "short" as const, label: "Short Term — 4 months", sub: "4 months \u2022 Testing & Quality Control" },
                ...
                {modalStep === "success" && (
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">Your interest in Textile Testing has been registered. We'll contact you soon.</p>
