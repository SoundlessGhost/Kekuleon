    ...
    <>
      ...
      <Section className="section bg-white">
        <div className="container-custom" id="programs">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            Comprehensive hands-on training in fabric testing, quality control,
            ...
            <div className="space-y-5">
              ...
              <div className="p-5 border-2 border-amber-200 bg-amber-50/50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Intensive practical training in textile testing, quality
              ...
              <div className="p-5 border-2 border-emerald-200 bg-emerald-50/50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Full training + Academic Research Project for PhD preparation
            ...
            <div>
              ...
              <div className="mt-8 border-l-2 border-emerald-400 pl-5">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Additional 2 months dedicated to textile research under expert
                  supervision. Topics include sustainable textiles, performance
                  fabrics, or quality optimization.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Train on industry-standard textile testing equipment used in
                quality labs across Bangladesh's RMG sector.
              </p>
      ...
      <Section className="section bg-white">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            Our training opens doors to international higher education, academic
            careers, and RMG industry positions.
          </p>
      ...
      <Section className="section bg-gray-50">
        <div className="container-custom">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl">
            KRTC's Textile department supports Bangladesh's RMG sector through
            affordable testing services for SMEs, worker training programs, and
      ...
      <Section className="py-16 bg-white">
        <div className="container-custom text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Start Your Textile Quality Career
          </h2>
          <p className="text-gray-600 mb-8">
            Join KRTC's Textile Testing department and develop expertise in
            quality assurance for Bangladesh's RMG sector. Scholarship
                        ...
                        {[
                          {
                            ...
                            sub: "4 months \u2022 Testing & Quality Control",
                          },
                          {
                            value: "long" as const,
                            label: "Long Term — 6 months",
                            sub: "6 months \u2022 Training + Research Project",
                          },
                        ].map((p) => (
                          <label
                            key={p.value}
                ...
                {modalStep === "success" && (
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Your interest in Textile Testing has been registered.
