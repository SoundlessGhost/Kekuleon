...
export const schoolingFeatures = [
  {
    ...
    description:
      "Comprehensive IELTS preparation and academic English training",
    icon: "Languages",
  },
  {
...
export const phdFeatures = [
  {
    ...
    description:
      "Industry-linked, problem-driven research addressing real-world challenges",
  },
  {
    title: "International Collaboration",
    description:
      "Co-supervision and partnerships with international universities",
  },
  {
    title: "Publication Support",
    description:
      "Research ethics, proposal development, and publication standards",
  },
  {
