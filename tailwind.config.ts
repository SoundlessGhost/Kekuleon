  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "mesh-gradient":
          "radial-gradient(at 40% 20%, hsla(358,82%,49%,0.1) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(358,82%,49%,0.08) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(358,82%,49%,0.05) 0px, transparent 50%)",
      },
      boxShadow: {
